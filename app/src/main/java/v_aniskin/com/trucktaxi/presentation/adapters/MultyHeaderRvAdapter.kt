 ...
 */
open class MultyHeaderRvAdapter<M, VC>: RecyclerView.Adapter<BaseHolder<M, VC>> {
    ...
    fun getData(): List<AdapterItemContainer<M>> {
      return mData
    }

    fun getItem(position: Int): AdapterItemContainer<M> {
